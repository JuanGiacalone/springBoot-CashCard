...
class CashCardApplicationTests {
	...
	void shouldCreateANewCashCard() {
		CashCard newCashCard = new CashCard(null, 321.45, "sarah1");
		...
		assertThat(amount).isEqualTo(321.45);
	}
	...
	/*
	Notice that we've added the @DirtiesContext annotation.
	...
	void shouldNotAllowDeletionOfCashCardsTheyDoNotOwn() {
		...
		// Checking that after the rejection the cashcard its still there
		ResponseEntity<String> getResponse = restTemplate
